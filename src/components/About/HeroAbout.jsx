...
const HeroAbout = () => {
  return (
    <section
      className="py-20 px-9 bg-cover bg-center bg-no-repeat text-white relative overflow-hidden"
    >
      <div className='absolute overflow-hidden bg-[#22c55e] -right-20 top-0 blur-[139px]  h-[250px] w-[208px]'></div>


      <div className="gap-10 flex">
        {/* Left Content */}
        <div className="px-10 py-10 flex flex-col gap-3">
          <h4 className="px-5 font-[500] text-[15px] py-1.5 rounded-full w-max bg-[#22c55e] text-center">
            Some Words About Us
          </h4>
          <div className="flex items-center space-x-3">
            <span className="text-[60px] font-bold">About Ecomine</span>
            <div className="flex -ml-2 h-[50px] w-[50px] items-center justify-center rounded-full bg-green-500">
              <span className="text-4xl font-bold">X</span>
            </div>
          </div>
          <p className="text-[16px] leading-[25px] w-[75%]">
          ...
          <p className="text-[16.5px] font-semibold pt-2 leading-[25px] w-[75%]">
        ...
        <div className="px-10 py-10 w-max">
