...
export default function OurFeatures() {
    ...
    return (
        <section className="w-full bg-[#111] py-16 overflow-x-hidden relative px-20">
            <div className='absolute overflow-hidden bg-[#22c55e]  blur-[139px]  -right-10 h-[180px] w-[180px]'></div>
            <div className="">
                <div className="text-center flex flex-col gap-4 items-center">
                    <h1 className="text-white font-[600] text-[48px] leading-[53px]"> Our
                        <span className="bg-gradient-to-r from-green-500 to-green-500 bg-clip-text text-transparent"> Features </span>
                    </h1>
                    <p className='w-[60%] text-[#d2d2d2] text-[14.5px]'>          Discover our comprehensive suite of mining solutions designed to maximize your crypto mining potential
                    </p>
                ...
                <div
                    ref={wrapRef}
                    className="relative mx-auto mt-10 rounded-3xl z-[99999]"
                    ...
                    <div className="overflow-hidden rounded-[28px]">
                        ...
                        >
                            {ITEMS.map((t, i) => (
                                <li
                                    key={i}
                                    className="shrink-0 relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#1a1a1a] to-[#111] py-12 h-[370px] px-9 shadow-[0_8px_30px_rgb(0,0,0,0.3)]"
                                    style={{ width: `${cardW}px` }}
                                >
                                    <div>
                                        <img className="absolute -right-20 top-14 opacity-25" src={t.bgImg} alt="" />
                                    ...
                                    <div className="relative z-50 flex flex-col justify-between gap-1">
                                        ...
                                        <h3 className="relative z-10 mb-3 mt-3 leading-tight  font-extrabold tracking-tight text-white">
                                            <span className="block text-[26px] leading-[30px]">{t.titleTop} </span>
                                            <span className="block text-[26px] leading-[32px] text-green-500">{t.titleBottom}</span>
                                        </h3>
